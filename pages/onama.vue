<template>
  <div
    ...
    <div class='max-w-lg'>
      <div class="relative flex items-center gap-x-4 ">
        <img
          ...
          alt="" class="h-10 w-10 rounded-full ring-1 ring-primary/5">
        <div class="text-lg leading-6">
          <h1 class="font-semibold text-4xl text-primary "> <a href="#"> <span class="absolute inset-0"></span>
              Poduke Parallel
            </a> </h1>
          <h2 class="text-zinc-500 text-2xl">
            O nama
    ...
    <div
      class=" bg-gradient-to-t max-w-md my-5 rounded-xl from-indigo-50 from-10% via-sky-50 via-30% to-emerald-50 to-90% dark:ring-white/10 ring-primary/5 flex flex-col p-[1px] h-96 w-full justify-center items-center  overflow-hidden relative bg-whiteshadow-xl">
      <iframe class=' max-w-md rounded-xl'
        ...
        width="100%" height="100%" style="border:0;" loading="async" referrerpolicy="no-referrer-when-downgrade"></iframe>
    </div>
    <div class=''>
      <div
